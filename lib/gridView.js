...
export class GridView extends ListView {
    ...
    MoveFocusLeft(com) {
        ...
        let leftItem = currentItem.Children.filter(x => x.Element.closest('td').style.display == "").find(x => x.Element.closest('td') === com.Element.closest('td').previousElementSibling);
        if (!leftItem) {
            return;
        }
    ...
    MoveFocusRight(com) {
        ...
        let leftItem = currentItem.Children.filter(x => x.Element.closest('td').style.display == "").find(x => x.Element.closest('td') === com.Element.closest('td').nextElementSibling);
        if (!leftItem) {
            return;
        }
        leftItem.Element.closest("td").focus();
