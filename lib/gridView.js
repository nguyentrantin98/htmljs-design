                    ...
                    switch (header.ComponentType) {
                        ...
                        case "Input":
                            ...
                            Html.End.Div.ClassName("btn-group").Button.TabIndex(-1).Event("click", (e) => {
                                ...
                                txtSearch.SearchMethod = txtSearch.SearchMethod == "asc" ? "desc" : "asc";
                                txtSearch.SearchIconElement.className = txtSearch.SearchMethod == "asc" ? "fas fa-sort-amount-up" : "fas fa-sort-amount-down";
