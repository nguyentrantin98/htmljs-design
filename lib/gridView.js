...
import { EditableComponent } from './index.js';
...
export class GridView extends ListView {
    ...
    AddSections() {
        ...
        Html.Take(this.Element).Div.ClassName("table-wrapper").Table.ClassName("table");
    ...
    ProcessHardDelete() {
        ...
        if (selectedRows.length === 0) {
            Toast.Warning("Please choose d");
            return;
        }
        var check = selectedRows.some(x => x["StatusId"] && [3, 4].includes(x["StatusId"]));
    ...
    async AddRows(rows, index = 0) {
        await this.DispatchCustomEvent(this.Meta.Events, CustomEventType.BeforeCreatedList, rows, this);
        const listItems = [];
    ...
    CalcSumCol(header, headers, tr, colSpan) {
        ...
        cellVal.textContent = sum.toFixed(pre || 0).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
    }
                    ...
                    switch (header.ComponentType) {
                        ...
                        case "Input":
                            ...
                            Html.End.Div.ClassName("btn-group").Button.TabIndex(-1).Event("click", (e) => {
                                ...
                                ctxMenu.MenuItems = [
                                    { Icon: "fas fa-circle", Text: '(Empty)', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Empty, Component: txtSearch, Icon: "fas fa-circle" } },
                                    { Icon: "fas fa-check-circle", Text: '(Filled)', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Filled, Component: txtSearch, Icon: "fas fa-check-circle" } },
                                    { Icon: "fas fa-equals", Text: 'Equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Equal, Component: txtSearch, Icon: "fas fa-equals" } },
                                    { Icon: "fas fa-not-equal", Text: 'Not equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.NotEqual, Component: txtSearch, Icon: "fas fa-not-equal" } },
                                    { Icon: "fas fa-check", Text: 'Contain', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Contain, Component: txtSearch, Icon: "fas fa-check" } },
                                    { Icon: "fas fa-times", Text: 'Do not contain', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.NotContain, Component: txtSearch, Icon: "fas fa-times" } },
                                    { Icon: "fas fa-angle-double-right", Text: 'Start with', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.StartWith, Component: txtSearch, Icon: "fas fa-angle-double-right" } },
                                    { Icon: "fas fa-angle-double-left", Text: 'End with', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.EndWith, Component: txtSearch, Icon: "fas fa-angle-double-left" } }
                                ];
                                ctxMenu.Render();
                        ...
                        case "Datepicker":
                            ...
                            Html.End.Div.ClassName("btn-group").Button.Event("click", (e) => {
                                const ele = e.target;
                                var buttonRect = ele.getBoundingClientRect();
                                var ctxMenu = ContextMenu.Instance;
                                ctxMenu.Top = buttonRect.bottom;
                                ...
                                ctxMenu.MenuItems = [
                                    { Icon: "fas fa-equals", Text: 'Equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Equal, Component: txtSearch, Icon: "fas fa-equals" } },
                                    { Icon: "fas fa-not-equal", Text: 'Not equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.NotEqual, Component: txtSearch, Icon: "fas fa-not-equal" } },
                                    { Icon: "fas fa-less-than", Text: 'Smaller', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Smaller, Component: txtSearch, Icon: "fas fa-less-than" } },
                                    { Icon: "fas fa-less-than-equal", Text: 'Smaller or equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.SmallerEqual, Component: txtSearch, Icon: "fas fa-less-than-equal" } },
                                    { Icon: "fas fa-greater-than", Text: 'Greater', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Greater, Component: txtSearch, Icon: "fas fa-greater-than" } },
                                    { Icon: "fas fa-greater-than-equal", Text: 'Greater or equal to', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.GreaterEqual, Component: txtSearch, Icon: "fas fa-greater-than-equal" } },
                                    { Icon: "fas fa-circle", Text: '(Empty)', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Empty, Component: txtSearch, Icon: "fas fa-circle" } },
                                    { Icon: "fas fa-check-circle", Text: '(Filled)', Click: this.FilterType.bind(this), Parameter: { Method: SearchMethodEnum.Filled, Component: txtSearch, Icon: "fas fa-check-circle" } }
                                ];
                                ctxMenu.Render();
                            }).TabIndex(-1).Span.ClassName(txtSearch.SearchIcon);
                            txtSearch.SearchIconElement = Html.Context;
                            break;
                        default:
                            var sec = new Section(null, Html.Context);
    ...
    /**
    * @param {SearchMethodEnum} method
    * @param {Textbox} component
    */
    FilterType(vm) {
        vm.Component.SearchMethod = vm.Method;
        vm.Component.SearchIconElement.className = vm.Icon;
    }
    /**
    ...
    RemoveHeader(arg) {
        ...
        confirm.YesConfirmed += () => {
            const ids = [entity.Id];
            Client.Instance.HardDeleteAsync(ids, 'Component')
                .then(success => {
                    if (!success) {
