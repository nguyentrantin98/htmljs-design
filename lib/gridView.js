        ...
        const columns = headerElements.map(header => {
            ...
            if (match && !header.Meta.StatusBar && Utils.isNullOrWhiteSpace(match.style.display)) {
                ...
                const dirtyPatch = [
                    ...
                    !anyGroup ? { Field: "Width", Value: width } : { Field: "Order", Value: header.Meta.Width },
                    !anyGroup ? { Field: "MaxWidth", Value: width } : { Field: "Order", Value: header.Meta.MaxWidth },
                    !anyGroup ? { Field: "MinWidth", Value: width } : { Field: "Order", Value: header.Meta.MinWidth },
