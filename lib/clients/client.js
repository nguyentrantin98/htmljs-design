...
export class Client {
    ...
    static get SystemRole() {
        if (Client.#systemRole == null) {
            if (typeof Token.parse(Client.Token.AccessToken).RoleIds === 'string') {
                Client.#systemRole = Token.parse(Client.Token.AccessToken).RoleIds == "8";
            }
            else {
                Client.#systemRole = Token.parse(Client.Token.AccessToken).RoleIds?.some(x => x == "8");
