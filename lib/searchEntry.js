...
export class SearchEntry extends EditableComponent {
    ...
    SetMatchedValue() {
        ...
        this.UpdateValue();
        if (this.IsCurrency) {
            this.Entity.ExchangeRateVND = this.Entity.ExchangeRateVND || (EditableComponent.ExchangeRateVND[this.GetValueText()] || 1);
            this.Entity.ExchangeRateUSD = this.Entity.ExchangeRateVND || (EditableComponent.ExchangeRateUSD[this.GetValueText()] || 1);
        }
    }
