        ...
        if (Utils.isNullOrWhiteSpace(this.Meta.RefName)) {
            ...
            if ((this._value && this.Matched && this.Matched.Id != this._value) || (!this.Matched && this._value)) {
                Client.Instance.GetByIdAsync(this.Meta.RefName, [this._value]).then(data => {
                    ...
                    this.SetMatchedValue();
                    if (this.IsCurrency) {
                        this.Entity.ExchangeRateVND = EditableComponent.ExchangeRateVND[this.GetValueText()];
                        this.Entity.ExchangeRateUSD = EditableComponent.ExchangeRateUSD[this.GetValueText()];
                        this.Entity.CurrencyCode = this.GetMatchedText(rowData);
                    }
                });
            }
            else {
