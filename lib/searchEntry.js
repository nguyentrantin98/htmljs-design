...
export class SearchEntry extends EditableComponent {
    ...
    Render() {
        ...
        this.RenderIcons();
        this.FindMatchText();
        this.SearchResultEle = this.EditForm.Element || document.body;
    }
    ...
    RenderIcons() {
        ...
        let div = Html.Instance.Icon('fa fa-info-circle').Title(LangSelect.Get('View detail data') + LangSelect.Get(this.Meta.Label))
