...
export class SearchEntry extends EditableComponent {
    ...
    FeatureLoaded(feature) {
        ...
        instance.DOMContentLoaded += () => {
            ...
            Html.Take(htmlTd).Button.ClassName('btn btn-secondary').Icon('fal fa-file-check').End.IText('Apply', this.EditForm.Meta.Label).Event('click', () => {
    ...
    RenderRootResult() {
        ...
        if (!this.IsSmallUp && this._backdrop === null) {
            ...
            Html.Instance.Div.ClassName('popup-content').Style('top: 0;width: 100%;')
                ...
                .Span.IText('Search', this.EditForm.Meta.Label).End.Div.ClassName('icon-box')
    ...
    SetMatchedValue() {
        ...
        if (this.IsCurrency) {
            ...
            this.Entity.ExSaleUSD = (EditableComponent.ExchangeRateSaleUSD[this.GetValueText()] || this.Entity.ExchangeRateUSD);
            this.Entity.ExSaleVND = (EditableComponent.ExchangeRateSaleVND[this.GetValueText()] || this.Entity.ExchangeRateVND);
            this.Entity.ExProfitUSD = (EditableComponent.ExchangeRateProfitUSD[this.GetValueText()] || this.Entity.ExchangeRateUSD);
            this.Entity.ExProfitVND = (EditableComponent.ExchangeRateProfitVND[this.GetValueText()] || this.Entity.ExchangeRateVND);
            this.Entity.CurrencyCode = this.GetValueText() || null;
        }
    }
