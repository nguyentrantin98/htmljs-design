...
export class SearchEntry extends EditableComponent {
        ...
        if (Utils.isNullOrWhiteSpace(this.Meta.RefName)) {
            ...
            if ((this._value && this.Matched && this.Matched.Id != this._value) || (!this.Matched && this._value)) {
                Client.Instance.GetByIdAsync(this.Meta.RefName, [this._value]).then(data => {
                    this.Matched = data.data ? data.data[0] : null;
                    this.SetMatchedValue();
                    if (this.IsCurrency && this._value != this.Matched.Id) {
                        this.Entity.ExchangeRateVND = EditableComponent.ExchangeRateVND[this.GetMatchedText(this.Matched)];
                        this.Entity.ExchangeRateUSD = EditableComponent.ExchangeRateUSD[this.GetMatchedText(this.Matched)];
                        this.Entity.CurrencyCode = this.GetMatchedText(this.Matched);
                    }
                });
            }
            else {
    ...
    ActEntrySelected(rowData) {
        ...
        if ((!this._value && rowData) || (this._value !== rowData.Id)) {
            if (this.IsCurrency) {
                this.Entity.ExchangeRateVND = EditableComponent.ExchangeRateVND[this.GetMatchedText(rowData)];
                this.Entity.ExchangeRateUSD = EditableComponent.ExchangeRateUSD[this.GetMatchedText(rowData)];
                this.Entity.CurrencyCode = this.GetValueText();
            }
        }
        let oldMatch = this.Matched;
