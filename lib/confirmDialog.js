...
export class ConfirmDialog extends EditableComponent {
    ...
    Render() {
        ...
        Html.Instance.Div.Event("keydown", (e) => this.HotKeyHandler(e)).MarginRem("top", 1).TextAlign("center");
        ...
        Html.Take(this.BodyElement).Div.Button2(this.YesText, "btn btn-success mt-2", "fal fa-check").Event("click", () => {
