...
export class ConfirmDialog extends EditableComponent {
    ...
    Render() {
        ...
        Html.Instance.Div.ClassName("bold").IText(this.Title).End.Div.ClassName("card").Event("keydown", (e) => this.HotKeyHandler(e)).Width(this.ComponentGroup ? "" : "450px").MarginRem("top", 1).TextAlign(this.ComponentGroup ? "" : "center");
