...
export class ConfirmDialog extends EditableComponent {
    ...
    Render() {
        ...
        Html.Instance.Div.Event("keydown", (e) => this.HotKeyHandler(e)).Width("402px").MarginRem("top", 1).TextAlign("center");
        ...
        Html.Take(this.BodyElement).Div.Style("width: 172px; margin: auto; padding: 1rem;").Button2(this.YesText, "btn btn-success mt-2", "fal fa-check").Event("click", () => {
