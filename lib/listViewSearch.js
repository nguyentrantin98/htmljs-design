...
export class ListViewSearch extends EditableComponent {
    ...
    Render() {
        ...
        Html.Take(this.Element).Div.ClassName('searching-block')
            .Button.ClassName("btn btn-secondary btn-sm mr-1").Event(EventType.Click, () => {
                this.Parent.ClearSelected();
                this.Parent.ReloadData().Done();
            }).Icon('fal fa-search')
            .End.End
            .Button.ClassName("btn btn-secondary btn-sm mr-1").Event(EventType.Click, this.AdvancedOptions.bind(this)).Icon('fal fa-cog').End.End
            .Button.ClassName("btn btn-secondary btn-sm mr-1").Event(EventType.Click, this.RefreshListView.bind(this)).Icon('fal fa-undo').End.End
            .Render();
    ...
    CalcFilterQuery() {
        ...
        const headers = this.Parent.Header;
