...
export class CodeEditor extends EditableComponent {
    ...
    EditorLoaded() {
        ...
        Html.Take(this.Element).Icon('fal fal fa-compress-wide').Style("position: absolute; z-index: 100; top: 0; right: 0;")
            .Event('click', () => {
                ComponentExt.FullScreen(this.Element);
            }).End.Icon('fal fa-history').Style("position: absolute; z-index: 100; bottom: 0; right: 0;")
            .Event('click', () => {
                this.RenderPopup();
    ...
    RenderPopup() {
        ...
        const res = {
            ComId: this.Meta.Id,
            Params: Utils.IsFunction(this.Meta.PreQuery, true, this),
