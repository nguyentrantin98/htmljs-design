...
export class CodeEditor extends EditableComponent {
    ...
    EditorLoaded() {
        ...
        monaco.editor.defineTheme('customJavaScriptTheme', {
            base: 'vs', // Or 'vs-dark' for dark mode
            inherit: true,
            rules: [
                { token: 'custom-editform', foreground: '800000', fontStyle: 'italic' }, // Dark red, italic
                { token: 'custom-filter', foreground: '008000', fontStyle: 'bold' },    // Green, bold
                { token: 'custom-find', foreground: '000080' },                         // Navy blue
                { token: 'custom-firstcom', foreground: '800080', fontStyle: 'italic' }, // Purple, italic
                { token: 'custom-loadmasterdata', foreground: 'ff4500' },               // Orange red
                { token: 'custom-reduce', foreground: '4682b4' },                       // Steel blue
                { token: 'custom-openconfig', foreground: 'daa520' },                   // Golden rod
                { token: 'custom-item', foreground: '2e8b57', fontStyle: 'italic' },    // Sea green, italic
                { token: 'custom-length', foreground: 'a52a2a' },                       // Brown
                { token: 'custom-updateview2', foreground: '5f9ea0' },                  // Cadet blue
                { token: 'custom-decimal', foreground: 'ff6347' },                      // Tomato red
                { token: 'custom-times', foreground: '4169e1', fontStyle: 'bold' },     // Royal blue, bold
                { token: 'custom-isnegative', foreground: '6a5acd', fontStyle: 'italic' }, // Slate blue, italic
                { token: 'custom-abs', foreground: 'dc143c', fontStyle: 'bold' },       // Crimson, bold
                { token: 'custom-plus', foreground: '8b0000' },                         // Dark red
                { token: 'custom-div', foreground: '228b22' },                          // Forest green
                { token: 'custom-parent', foreground: 'ffa07a', fontStyle: 'italic' }   // Light salmon, italic
            ]
        });
        window.setTimeout(() => {
            this.editor = monaco.editor.create(this.Element, {
                ...
                theme: this.Meta.Theme ?? 'customJavaScriptTheme',
