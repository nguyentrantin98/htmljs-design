...
export class Datepicker extends EditableComponent {
    ...
    set Value(value) {
        ...
        if (this.value) {
            ...
            this.Entity[this.Name] = dayjs(this.value).format('YYYY-MM-DDTHH:mm:ss.SSS[Z]');
    ...
    RenderCalendar(someday = null) {
        ...
        this._closeAwaiter = setTimeout(() => {
            this.RenderCalendarTask(someday || this.value || dayjs());
        }, 100);
    }
    ...
    RenderCalendarTask(someday) {
        ...
        let _someday = someday || this.value || dayjs();
        this.show = true;
        clearTimeout(this._closeAwaiter);
        ...
        if (this.Meta.Precision === 7) {
            Html.Instance.Div.ClassName("Time")
                ...
                .Event("click", () => clearTimeout(this._closeAwaiter))
