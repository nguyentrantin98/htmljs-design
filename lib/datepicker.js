...
export class Datepicker extends EditableComponent {
    ...
    Render() {
        ...
        this.flatpickr = flatpickr(this.Input, {
            ...
            dateFormat: (this.Meta.Precision === 7 ? "dd/mm/Y HH:ii" : "d/m/Y"),
            ...
            onChange: (selectedDates, dateStr, instance) => {
                const selected = dayjs(selectedDates[0]);
                this.TriggerUserChange(selected);
                this.flatpickr.setDate(selected.format(this.InitFormat), false);
            }
        });
        let str = null;
        if (this.Entity[this.Name]) {
            ...
            this.flatpickr.setDate(str, false);
        }
        else {
            this.value = null;
            this.flatpickr.setDate(null, false);
        }
