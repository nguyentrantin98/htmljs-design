...
export class EditableComponent {
    ...
    ToggleDisabled(disabled) {
        ...
        if ((this.Entity["NoSubmit"] || this.Entity["IsLock"] || this.Entity["IsPayment"] || this.Entity["IsInvoice"] || (this.Entity["IsPaid"] && this.Parent.IsListViewItem)) && !this.Meta.Disabled) {
