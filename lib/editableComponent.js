...
export class EditableComponent {
    ...
    ToggleDisabled(disabled) {
        ...
        if (this.Entity && this.Token && ((this.Meta.CanWrite && this.Entity["InsertedBy"] == this.Token.UserId) || this.Meta.CanWriteAll)) {
    ...
    AddChild(child, index = null, showExp = null, disabledExp = null) {
        ...
        if (child.Meta
            ...
            && !child.IsButton
            && (child.Entity["InsertedBy"] != this.Token.UserId
                && ((child.Entity["AssignId"] && child.Entity["AssignId"] != this.Token.UserId) || !child.Entity["AssignId"]))
        ) {
            child.Disabled = true;
        }
        // @ts-ignore
        ...
        if (disabledExp || (child.Meta && child.Meta.DisabledExp && (child.Entity && (child.Meta.CanWrite && child.Entity["InsertedBy"] == this.Token.UserId) || child.Meta.CanWriteAll))) {
