...
export class EditableComponent {
    ...
    AddChild(child, index = null, showExp = null, disabledExp = null) {
        ...
        if (child.Meta
            ...
            && (!child.Meta.CanWriteAll || (this.EditForm && this.EditForm.Entity && this.EditForm.Entity["StatusId"] == 3))
            && !child.IsButton
            && ((child.Entity["InsertedBy"] != this.Token.UserId && child.Entity["AssignId"] != this.Token.UserId) || child.Entity["NoSubmit"] || child.Entity["IsLock"] || (this.EditForm && this.EditForm.Entity && this.EditForm.Entity["StatusId"] == 3))) {
            child.Disabled = true;
        }
        // @ts-ignore
