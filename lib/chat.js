...
export class Chat extends EditableComponent {
    ...
    */
    ...
    AddMessageToDOM(item) {
        ...
        if (this.Token.UserId == item.FromId) {
            ...
            Html.Instance.InnerHTML(item.Message).End.End.Render();
        }
        if (this.Token.UserId == item.FromId) {
    ...
    */
    ...
    RenderChat() {
        ...
        Html.Instance.Div.ClassName("name2").Span.IText(this.Entity.Label)
        this.FeatureText = Html.Context;
        Html.Instance.End.Span.Text(" : ").End.Span.Text(this.Entity.FormatChat);
    ...
    UndoAction(item) {
        ...
        console.log("Undo action for item:", item);
    }
    ...
    RedoAction(item) {
        // Implement the redo action
        console.log("Redo action for item:", item);
    }
