...
export class ButtonPdf extends Button {
    ...
    */
    ...
    async DispatchClickAsync() {
        ...
        css.textContent = `body { font-family: 'Montserrat'; font-size: 10pt; } * { margin: 0; padding: 0; box-sizing: border-box; } table { font-size: unset; } .logo { min-width: 110px; min-height: 56px; } .dashed tbody td { border-bottom: 0.01px dashed rgb(126, 140, 141) !important; } @media print { thead { display: table-header-group; } tfoot { display: table-footer-group; } table { page-break-inside: auto; } tr { page-break-inside: avoid; } }`;
