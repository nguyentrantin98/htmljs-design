...
export class Label extends EditableComponent {
    ...
    Render() {
        ...
        this.OriginalText = new DOMParser().parseFromString(cellText, 'text/html').body.textContent;
    }
    /**
    ...
    UpdateEle(cellText) {
        ...
        this.Element.setAttribute("title", new DOMParser().parseFromString(cellText, 'text/html').body.textContent);
    }
