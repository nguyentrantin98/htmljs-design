...
export class Image extends EditableComponent {
    ...
    RenderFileThumb(path) {
        ...
        if (isImage) {
            ...
            img.addEventListener('click', () => this.PreviewPDF(path));
        } else {
            ...
            if (thumbText.includes(".pdf")) {
                ...
                thumbText.includes(".xls") || thumbText.includes(".xlsx")) {
    ...
    */
    ...
    openPopupIFrame(url) {
        ...
        Html.Instance.Iframe.ClassName("container-rpt").Style("margin:auto;background:#fff;overflow: auto;min-height:calc(100vh - 10rem);");
