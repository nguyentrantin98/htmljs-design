...
export class EditForm extends EditableComponent {
    ...
    GetComPolicies(entityName = "Component", ...components) {
        ...
        var newComponents = components.map(com => {
            var check1 = policyFeature.CanRead;
            ...
            if (check2 && check2.CanRead) {
                ...
                com.CanDelele = check2.CanDelele;
                com.CanDeleleAll = check2.CanDeleleAll;
                com.CanDeactivate = check2.CanDeactivate;
                com.CanDeactivateAll = check2.CanDeactivateAll;
                return com;
            }
            else if (check1) {
                com.CanWrite = check1.CanWrite;
                com.CanWrite = check1.CanWrite;
                com.CanWriteAll = check1.CanWriteAll;
                com.CanRead = check1.CanRead;
                com.CanReadAll = check1.CanReadAll;
                com.CanDelele = check1.CanDelele;
                com.CanDeleleAll = check1.CanDeleleAll;
                com.CanDeactivate = check1.CanDeactivate;
                com.CanDeactivateAll = check1.CanDeactivateAll;
                return com;
            }
            else {
                return null;
