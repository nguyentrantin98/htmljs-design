...
export class EditForm extends EditableComponent {
    ...
    async LoadFeatureAndRender(callback = null) {
        ...
        if (this.Popup) {
            ...
            Html.Instance.End.Div.ClassName("icon-box d-flex").Style("display: flex; gap: 20px; align-items: center;").Span.Event(EventType.Click, handlerMail).ClassName("fa fa-mailbox").End.Span.ClassName("fa fa-times")
