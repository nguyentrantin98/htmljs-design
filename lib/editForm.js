...
export class EditForm extends EditableComponent {
    ...
    async ActSendEntity() {
        ...
        if (res.status == 200) {
            ...
            this.Dirty = false;
            this.UpdateView(true);
            Toast.Warning("Your submission was successful.")
        }
        else {
    ...
    async ActApprovedEntity() {
        ...
        if (res.status == 200) {
            ...
            this.Dirty = false;
            this.UpdateView(true);
            Toast.Warning("Your approved was successful.")
        }
        else {
    ...
    async ActDeclineEntity() {
        ...
        if (res.status == 200) {
            ...
            this.Dirty = false;
            this.UpdateView(true);
            Toast.Warning("Your decline was successful.")
        }
        else {
