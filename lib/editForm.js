...
export class EditForm extends EditableComponent {
        ...
        var patchModels = gridItem.map(item => {
            ...
            if (allItem && allItem.length > 0) {
                allItem.forEach(it => {
                    ...
                    if (currency) {
                        it.Entity.ExchangeRateVND = it.Entity.ExchangeRateVND || EditableComponent.ExchangeRateVND[currency.GetValueText()] || 1;
                        it.Entity.ExchangeRateUSD = it.Entity.ExchangeRateUSD || EditableComponent.ExchangeRateUSD[currency.GetValueText()] || 1;
    ...
    async SavePatch(element, entity, dirty, reloadData) {
        ...
        try {
            ...
            if (currency) {
                this.Entity.ExchangeRateVND = this.Entity.ExchangeRateVND || EditableComponent.ExchangeRateVND[currency.GetValueText()] || 1;
                this.Entity.ExchangeRateUSD = this.Entity.ExchangeRateUSD || EditableComponent.ExchangeRateUSD[currency.GetValueText()] || 1;
