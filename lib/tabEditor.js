...
export class TabEditor extends EditForm {
    static TabWrapper = document.getElementById("tabs") ?? document.body;
    static get TabContainer() {
        const container = document.getElementById("tab-content");
        if (container == null) {
            const html = new HTML();
            TabEditor.TabWrapper.appendChild(html.Div.Id('tab-content').Context);
        }
    }
    /** @type {TabEditor[]} */
    static Tabs = [];
    ...
    RenderPopup() {
        ...
        Html.Instance.Div.ClassName("popup-content").Div.ClassName("popup-title").Span.IText(this.Title);
        ...
        Html.Instance.End.Div.ClassName("menu-item");
        this.PopUpMenu = Html.Context;
        Html.Instance.End.End.Div.ClassName("popup-body");
        this.Element = Html.Context;
        super.Render();
