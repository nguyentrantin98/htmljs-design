...
export class Chart extends EditableComponent {
    ...
    ShowSearch() {
        ...
        Html.Instance.Div.ClassName("apexcharts-menu-item").TabIndex(-1).IText("This year", this.EditForm.Meta.Label).End
            .Div.TabIndex(-1).ClassName("apexcharts-menu-item").IText("Q1", this.EditForm.Meta.Label).End
            .Div.TabIndex(-1).ClassName("apexcharts-menu-item").IText("Q2", this.EditForm.Meta.Label).End
            .Div.TabIndex(-1).ClassName("apexcharts-menu-item").IText("Q3", this.EditForm.Meta.Label).End
            .Div.TabIndex(-1).ClassName("apexcharts-menu-item").IText("Q4", this.EditForm.Meta.Label).End
            .End.Render();
