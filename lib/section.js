...
export class Section extends EditableComponent {
    ...
    Render() {
        ...
        if (this.Meta.Html && this.Meta.Html != '') {
            ...
            const allComPolicies = !this.Meta.Id && this.EditForm
                ...
                : [];
            // @ts-ignore
            EditForm.SplitChild(this.Element.children, allComPolicies, section);
    ...
    static RenderGroupContent(parent, groupInfo, writePermission = true, width, entity, editForm) {
        /**@type {EditForm}*/
        ...
        Html.Instance.Div.Event(EventType.ContextMenu, (e) => form.SysConfigMenu(e, null, groupInfo, null)).ClassName("section-item").Width(width).Div.ClassName(groupInfo.ClassName ?? "");
        if (groupInfo.Label) {
        ...
        section.Disabled = parent.Disabled || groupInfo.Disabled || !writePermission;
        // @ts-ignore
    ...
    SetDisableUI(disabled) {
        console.log("SetDisableUI Section")
        debugger;
