...
export class Section extends EditableComponent {
    ...
    static RenderGroupContent(parent, groupInfo, writePermission, width, entity, editForm) {
        ...
        Html.Instance.Div.ClassName("section-item").Width(width).Div.ClassName(groupInfo.ClassName ?? "").Event(EventType.ContextMenu, (e) => form.SysConfigMenu(e, null, groupInfo, null));
        if (groupInfo.Label) {
