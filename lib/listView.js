...
export class ListView extends EditableComponent {
    ...
    */
    ...
    copyRowWithoutId(selectedRows, path = null) {
        return selectedRows.map(row => {
            ...
            this.setPropValue(res, "IsPayment", 0);
            ...
            this.setPropValue(res, "IsInvoice", 0);
    ...
    */
    ...
    RenderEditMenu() {
        ...
        var selected = this.GetSelectedRows();
        var check = selected.some(x => (x["StatusId"] && !x["ProgressId"] && [3, 4].includes(x["StatusId"])) || (x["ProgressId"] && [2, 3].includes(x["ProgressId"])) || x["NoSubmit"] || x["IsLock"] || x["IsPayment"] || x["IsInvoice"]);
    ...
    */
    ...
    async HardDeleteSelected() {
        ...
        var check = deletedItems.some(x => (x["StatusId"] && [3, 4].includes(x["StatusId"])) || x["NoSubmit"] || x["IsLock"] || x["IsPayment"] || x["IsInvoice"]);
