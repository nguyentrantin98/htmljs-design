...
export class ListView extends EditableComponent {
    ...
    SetRowData(listData) {
        ...
        if (this.RowData._data === null || typeof this.RowData._data === "string") {
            ...
            this.RowData._data.length = 0;
            if (listData && listData.length > 0) {
                listData.forEach(item => this.RowData._data.push(item));
            }
        }
        this.RenderContent();
            ...
            this.AllListViewItem.filter(x => x.Selected).forEach(x => {
                ...
                if (x.GroupSection && x.GroupSection.ChildrenItems.length > 0) {
                    ...
                    if (x.GroupSection.ChildrenItems.length == 0) {
                        const index1 = this.AllListViewItem.indexOf(x.GroupSection);
    ...
    MoveUp() {
        ...
        if (!selected) {
            if (this.AllListViewItem[this.AllListViewItem.length - 1]) {
                ...
                this.AllListViewItem[this.AllListViewItem.length - 1].Element.focus();
            ...
            if (!this.AllListViewItem[indexCurrent - 1]) {
                ...
                this.AllListViewItem[indexCurrent - 1].Element.focus();
    ...
    MoveDown() {
        ...
        if (!selected) {
            if (this.AllListViewItem[0]) {
                ...
                this.AllListViewItem[0].Element.focus();
