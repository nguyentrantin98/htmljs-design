...
export class ListView extends EditableComponent {
    ...
    */
    ...
    RenderEditMenu() {
        ...
        var selected = this.GetSelectedRows();
        var check = selected.some(x => (x["StatusId"] && !x["ProgressId"] && [3, 4].includes(x["StatusId"])) || (x["ProgressId"] && [2, 3].includes(x["ProgressId"])) || x["NoSubmit"] || x["IsLock"] || x["IsPayment"] || x["IsInvoice"] || x["IsPaymentAcc"] || x["IsDebtAcc"] || x["IsPaid"]);
    ...
    */
    ...
    async HardDeleteSelected() {
        ...
        var check = deletedItems.some(x => (x["StatusId"] && [3, 4].includes(x["StatusId"])) || x["NoSubmit"] || x["IsLock"] || x["IsPayment"] || x["IsInvoice"] || x["IsPaymentAcc"] || x["IsDebtAcc"] || x["IsPaid"]);
