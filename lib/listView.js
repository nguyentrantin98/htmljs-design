...
export class ListView extends EditableComponent {
    ...
    get Item() { return this.MainSection.Children; }
    /**
    ...
    BodyContextMenuHandler(e) {
        ...
        if (this.Disabled || !this.Meta.CanWrite || (this.Meta.CanWrite
            && !this.Meta.CanWriteAll
            && (this.EntityId && !this.EntityId.startsWith("-") && this.Entity["InsertedBy"] == this.Token.UserId))) {
            return;
        }
