...
export class Numbox extends EditableComponent {
    ...
    set Value(value) {
        ...
        if (value === null || value == undefined) {
            ...
            if (success) {
                ...
                var text = this._value.toFixed(this.IsVND ? 0 : (this.Meta.Precision ?? 0)).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
    ...
    Render() {
        ...
        if (this.Entity && this.Entity.Currency && this.Entity.Currency.Name == "VND" && this.Meta.GroupTypeId != "00d41484-0000-0000-8000-7725fc908bab") {
            this.IsVND = true;
        } else {
            this.IsVND = false;
        }
    ...
    UpdateView(force = false, dirty = null, ...componentNames) {
        if (this.Entity && this.Entity.Currency && this.Entity.Currency.Name == "VND") {
            this.IsVND = true;
        }
        else {
            this.IsVND = false;
