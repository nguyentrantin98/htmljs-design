...
export class Numbox extends EditableComponent {
    ...
    set Value(value) {
        ...
        if (((oldValue == null || oldValue == undefined) && this._value !== null) || ((this._value == null || this._value == undefined) && oldValue !== null)) {
            this.Dirty = true;
        }
        else {
            if (oldValue != null && this._value != null && !oldValue.equals(this._value)) {
                this.Dirty = true;
            }
        }
    ...
    SetValue() {
        ...
        this.DispatchEvent(this.Meta.Events, EventType.Input, this.Entity, this._value, oldVal).then();
    }
