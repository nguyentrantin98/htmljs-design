    ...
    return (
        <div className="action" ref={menuRef}>
            <div className="profile avatar" onClick={() => setState(!state)}>
                <img src="https://amisplatform.misacdn.net/APIS/PlatformAPI/api/Avatar/8a05ea46-eb2d-4af5-b5da-8863c324c89f/BS27GS4Q.jpg?avatarID=2a14a261-f827-4f35-9861-b922a9001b1f&amp;imageType=jpg&amp;appCode=Accounting&amp;width=64&amp;height=64" className="h-full w-full" />
            </div>
                            ...
                            <div className="list_option list_option_user">
                                ...
                                <div className="loyalty-container flex items-center">
                                    ...
                                    <div className="loyalty-wrap">
                                        <div className="loyalty-title">Giấy phép &amp; Thanh toán</div>
                                    </div>
                                </div>
                                <div className="loyalty-container flex items-center">
                                ...
                                <div className="loyalty-container flex items-center">
                                    ...
                                    <div className="loyalty-wrap">
                                        <div className="loyalty-title">Chính sách quyền riêng tư</div>
                                    </div>
                                </div>
